 ...
 */
final class Version20191114195230 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__file AS SELECT id, user_id, token, filename, create_date, update_date, checksum, description, metadata FROM file');
        ...
        $this->addSql('INSERT INTO file (id, user_id, token, filename, create_date, update_date, checksum, description, metadata) SELECT id, user_id, token, filename, create_date, update_date, checksum, description, metadata FROM __temp__file');
